    ...
    <div id="body" class="col-md-12">
        ...
        <?php echo form_open("daftar/save")?>
          <div class="form-group row">
            ...
            <div class="col-8">
                <input id="alasan" name="alasan" placeholder="Masukkan Alasan Pendaftar" type="text" class="form-control">
            </div>
          </div>
<br>
          <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <?php
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <input id="nosertifikat" name="nosertifikat" placeholder="Masukkan Nomor Sertifikat Peserta" type="text" class="form-control">
            </div>
          </div>
